...
<div class="page-title-bar">
    <h1><i class="bi bi-info-circle me-2" style="color:var(--primary);"></i>
        {{ isset($section->id) ? 'تعديل: ' . $section->title_ar : 'إضافة قسم جديد' }}
    </h1>
    <a href="{{ route('admin.about.index') }}" class="btn btn-outline-secondary rounded-3">
...
<div class="admin-card card">
    <div class="card-body">
        <form action="{{ isset($section->id) ? route('admin.about.update', $section->id) : route('admin.about.store') }}"
            ...
            <div class="row g-4">
                <div class="col-md-4">
                    ...
                    <input type="text" name="section_key" class="form-control" dir="ltr"
                        ...
                        placeholder="intro, vision, mission, history..."
                        {{ isset($section->id) ? '' : 'required' }}>
                    <small class="text-muted">حروف صغيرة وشرطة سفلية فقط</small>
                </div>
                <div class="col-md-4">
                    <label class="form-label">الترتيب</label>
                    <input type="number" name="order" class="form-control" value="{{ old('order', $section->order ?? 0) }}" min="0">
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="icon" class="form-control" dir="ltr"
                        value="{{ old('icon', $section->icon) }}" placeholder="bi-star-fill">
                </div>
                <div class="col-md-8">
                    <label class="form-label">الصورة</label>
                    @if(isset($section->image) && $section->image)
                    <div class="mb-2">
                        <img src="{{ Storage::url($section->image) }}" class="img-preview d-block mb-1">
                    </div>
                    @endif
                ...
                <div class="col-12">
                    ...
                    <a href="{{ route('admin.about.index') }}" class="btn btn-light px-4 rounded-3 ms-2">إلغاء</a>
                </div>
            </div>
        </form>
    </div>
